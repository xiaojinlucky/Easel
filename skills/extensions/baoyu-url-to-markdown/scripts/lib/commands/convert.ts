...
import { installPublicNetworkGuard } from "../browser/public-network";
...
async function openRuntime(
  ...
  if (process.env.EASEL_PUBLIC_RESEARCH_DOMAINS) {
    await installPublicNetworkGuard(browser.targetSession, JSON.parse(process.env.EASEL_PUBLIC_RESEARCH_DOMAINS));
  }
  if (interactive) {
