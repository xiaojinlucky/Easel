...
import {
  ...
  IconDashboard, IconWorkflow, IconSettings,
} from './icons';

export type Page = 'dashboard' | 'chat' | 'trends' | 'ideas' | 'calendar' | 'publish' | 'breakdown' | 'skills' | 'workflows' | 'outputs' | 'accounts' | 'profile' | 'model-settings';
